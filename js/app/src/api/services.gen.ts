 ...
 * Update User Profile
 */
export const updateUserProfile = <ThrowOnError extends boolean = false>(options: Options<UpdateUserProfileData, ThrowOnError>) => { return (options?.client ?? client).post<UpdateUserProfileResponse, UpdateUserProfileError, ThrowOnError>({
    ...options,
    url: '/user/profile'
}); };
 ...
 * Btc Price
 */
export const btcPrice = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<BtcPriceResponse, BtcPriceError, ThrowOnError>({
    ...options,
    url: '/btc_price'
}); };