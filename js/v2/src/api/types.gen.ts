...
export type PodcastAnalytics = {
    podcast: Podcast;
    podclips: Array<PodclipAnalytics>;
};
...
export type CreatorDashboardResponse = (DashboardReponse);

export type CreatorDashboardError = unknown;

export type PodcastBreakdownData = {
    path: {
        podcast_id: string;
    };
};

export type PodcastBreakdownResponse = (PodcastAnalytics);

export type PodcastBreakdownError = (HTTPValidationError);
