...
import { Box, Typography, IconButton, Card, CardContent, CardMedia, Slider } from '@mui/material';
        ...
        <CardContent sx={{ p: 1, pt: 1 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Box sx={{ flexGrow: 1, mr: 2 }}>
              <Typography variant="subtitle2" color="text.primary" noWrap>{podcast?.title}</Typography>
